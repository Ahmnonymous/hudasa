...
const tableName = 'Academic_Results';

const academicResultsModel = {
  ...
  getAll: async (centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error fetching all records from Academic_Results: " + err.message);
    }
  },
  ...
  getById: async (id, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error fetching record by ID from Academic_Results: " + err.message);
    }
  },

  // ? getByMadressahAppId - Get academic results for a specific madressah application
  getByMadressahAppId: async (madressahAppId, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error fetching records by madressah app ID from Academic_Results: " + err.message);
    }
  },
  ...
  create: async (fields) => {
    try {
      ...
      throw new Error("Error creating record in Academic_Results: " + err.message);
    }
  },
  ...
  update: async (id, fields, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error updating record in Academic_Results: " + err.message);
    }
  },
  ...
  delete: async (id, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error deleting record from Academic_Results: " + err.message);
    }
  }
};

module.exports = academicResultsModel;
