...
const financialAssessmentModel = {
  ...
  getAll: async (centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error fetching all records from Financial_Assessment: " + err.message);
    }
  },
  ...
  getById: async (id, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error fetching record by ID from Financial_Assessment: " + err.message);
    }
  },
  ...
  create: async (fields) => {
    try {
      ...
      throw new Error("Error creating record in Financial_Assessment: " + err.message);
    }
  },
  ...
  update: async (id, fields, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error updating record in Financial_Assessment: " + err.message);
    }
  },
  ...
  delete: async (id, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error deleting record from Financial_Assessment: " + err.message);
    }
  }
};
