...
const tableName = 'Madressah_Application';

const madressaApplicationModel = {
  ...
  getAll: async (centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error fetching all records from Madressa_Application: " + err.message);
    }
  },
  ...
  getById: async (id, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error fetching record by ID from Madressa_Application: " + err.message);
    }
  },

  // ? getByRelationshipId - Get applications for a specific relationship (student)
  getByRelationshipId: async (relationshipId, centerId = null, isMultiCenter = false) => {
    try {
      let where = `applicant_relationship_id = $1`;
      ...
      throw new Error("Error fetching records by relationship ID from Madressa_Application: " + err.message);
    }
  },
  ...
  create: async (fields) => {
    try {
      ...
      throw new Error("Error creating record in Madressa_Application: " + err.message);
    }
  },
  ...
  update: async (id, fields, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error updating record in Madressa_Application: " + err.message);
    }
  },
  ...
  delete: async (id, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error deleting record from Madressa_Application: " + err.message);
    }
  }
};

module.exports = madressaApplicationModel;
