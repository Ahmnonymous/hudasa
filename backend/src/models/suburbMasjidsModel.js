...
const tableName = 'Suburb_Masjids';

const suburbMasjidsModel = {
  getAll: async (centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error fetching all records from Suburb_Masjids: " + err.message);
    }
  },
  ...
  getById: async (id, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error fetching record by ID from Suburb_Masjids: " + err.message);
    }
  },
  ...
  getBySuburbId: async (suburbId, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error fetching records by Suburb ID from Suburb_Masjids: " + err.message);
    }
  },
  ...
  create: async (fields) => {
    try {
      ...
      throw new Error("Error creating record in Suburb_Masjids: " + err.message);
    }
  },
  ...
  update: async (id, fields, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error updating record in Suburb_Masjids: " + err.message);
    }
  },
  ...
  delete: async (id, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error deleting record from Suburb_Masjids: " + err.message);
    }
  }
};

module.exports = suburbMasjidsModel;
