...
const surveyModel = {
  ...
  getAll: async (centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error fetching all records from Survey: " + err.message);
    }
  },
  ...
  getById: async (id, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error fetching record by ID from Survey: " + err.message);
    }
  },

  // ? getByMadressahAppId - Get surveys for a specific madressah application
  getByMadressahAppId: async (madressahAppId, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error fetching records by madressah app ID from Survey: " + err.message);
    }
  },
  ...
  create: async (fields) => {
    try {
      ...
      throw new Error("Error creating record in Survey: " + err.message);
    }
  },
  ...
  update: async (id, fields, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error updating record in Survey: " + err.message);
    }
  },
  ...
  delete: async (id, centerId = null, isMultiCenter = false) => {
    try {
      ...
      throw new Error("Error deleting record from Survey: " + err.message);
    }
  }
};
