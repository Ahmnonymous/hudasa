...
-- ============================================================================
-- MADRESSA MODULE TABLES (from migration-apex-tables.sql)
-- ============================================================================
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'fk_marital_status_rel' AND table_name = 'relationships') THEN
        ALTER TABLE Relationships
            ADD CONSTRAINT fk_marital_status_rel FOREIGN KEY (Marital_Status) REFERENCES Marital_Status(ID);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'fk_religion_rel' AND table_name = 'relationships') THEN
        ALTER TABLE Relationships
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'fk_home_visit_type' AND table_name = 'home_visit') THEN
        ALTER TABLE Home_Visit
