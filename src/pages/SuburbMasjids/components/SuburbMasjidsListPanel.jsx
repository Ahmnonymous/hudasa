...
const SuburbMasjidsListPanel = ({
  ...
  const getSuburbName = (suburbId) => {
    ...
    return suburb?.name || `Suburb ID: ${suburbId}`;
  };
      ...
      <CardBody className="p-0 d-flex flex-column">
        <div className="p-3 border-bottom">
          ...
          <div className="position-relative">
            <Input
              type="text"
              placeholder="Search by name or imaam..."
              value={searchTerm}
        ...
        <div className="flex-grow-1 p-3" style={{ height: "calc(100vh - 200px)", overflowY: "auto" }}>
          ...
          {!loading && masjids.length === 0 && (
            <div className="text-center py-4">
              ...
              <h6 className="font-size-13 mb-1">No Masjids Found</h6>
                  ...
                  >
                    <div className="d-flex justify-content-between align-items-center">
                      <div className="flex-grow-1">
                        ...
                        >
                          {getSuburbName(masjid.suburb_id)}
                        </p>
                        {masjid.imaam_name && (
                          <p
...
export default SuburbMasjidsListPanel;
